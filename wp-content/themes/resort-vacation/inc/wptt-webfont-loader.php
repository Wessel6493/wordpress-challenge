...
if ( ! class_exists( 'Resort_Vacation_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Resort_Vacation_WPTT_WebFont_Loader {
		...
		public function get_remote_url_contents() {
			...
			$resort_vacation_contents = wp_remote_retrieve_body( $response );

			return $resort_vacation_contents;
		}
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Resort_Vacation_WPTT_WebFont_Loader( $url );
