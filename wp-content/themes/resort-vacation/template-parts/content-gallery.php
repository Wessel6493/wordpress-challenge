...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<header class="entry-header">
	 ...
	 <?php
		    ...
		    $resort_vacation_gallery_shortcode = get_post_gallery();

		    if (!empty($resort_vacation_gallery_shortcode)) {
		        // Display the gallery
		        echo '<div class="embedded-gallery">' . do_shortcode($resort_vacation_gallery_shortcode) . '</div>';
		    }
		?>
    <?php
